...
RETURNING jobs.id, jobs.type, jobs.payload, jobs.status, jobs.priority, jobs.attempts, jobs.run_at, jobs.locked_at, jobs.locked_by, jobs.last_error, jobs.idempotency_key, jobs.created_at, jobs.updated_at
`
