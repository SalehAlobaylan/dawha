...
VALUES
  ...
  ('10000000-0000-0000-0000-000000000005', 'عبد الله', 'عبد الله', 'male', '1120-01-01', '1185-12-31', '1188-01-01', '1210-12-31', 'unreviewed', 'سجل مكرر محتمل للاختبار.', '00000000-0000-0000-0000-000000000001')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO entity_relationships (id, subject_type, subject_id, predicate, object_type, object_id, status, created_by)
VALUES ('e0000000-0000-0000-0000-000000000001', 'person', '10000000-0000-0000-0000-000000000005', 'father_of', 'person', '10000000-0000-0000-0000-000000000002', 'supported', '00000000-0000-0000-0000-000000000001')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ('a0000000-0000-0000-0000-000000000001', 'person', '10000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'documented_in', '1180-01-01', '1210-12-31', 'documented', 'approximate', '30000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001'),
  ('a0000000-0000-0000-0000-000000000002', 'person', '10000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000001', 'documented_in', '1180-01-01', '1210-12-31', 'documented', 'approximate', '30000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001')
ON CONFLICT (id) DO NOTHING;
