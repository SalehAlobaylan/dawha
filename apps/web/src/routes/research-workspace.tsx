  ...
  return <div className="page-stack workspace-page">
    ...
    <div className="workspace-grid">
      <main className="workspace-main">
        ...
        <ResearchAgentPanel snapshot={snapshot} canRun={permissions.canRunResearchAgent} />
